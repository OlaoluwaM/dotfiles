...
const mocha = {
  ...
  color_scheme: "dark",
  bg_color: "#1e1e2e",
  fg_color: "lighten(#CDD6F4, 10%)",
  hover_fg: "lighten($fg_color, 15%)",
  hypr_active_border: "#b4befe",
  hypr_inactive_border: "#6C7086",
  accent: "#45475a",
  accent_fg: "#181825",
  border_width: 0,
